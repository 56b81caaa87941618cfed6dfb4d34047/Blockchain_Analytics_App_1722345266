...
Vue.component("purple_header_component_1722345270", {
    template: `
            ...
            <div class="flex items-center justify-between h-16 md:h-20">
                ...
                <nav id="desktop-navigation" class="hidden md:flex md:grow">
                    ...
                    <ul id="desktop-menu-links" class="flex grow justify-center flex-wrap items-center">
                        <li><a id="Blockchain Explorer-link" class="font-medium text-sm mx-4 lg:mx-5 transition duration-150 ease-in-out" :class="[textStylePrimary, hoverTextStylePrimary]" href="Blockchain Explorer.html">Blockchain Explorer</a></li>
                        <li><a id="Data Analysis-link" class="font-medium text-sm mx-4 lg:mx-5 transition duration-150 ease-in-out" href="Data Analysis.html" :class="[textStylePrimary, hoverTextStylePrimary]">Data Analysis</a></li>
                        <li><a id="Smart Contracts-link" class="font-medium text-sm mx-4 lg:mx-5 transition duration-150 ease-in-out" href="Smart Contracts.html" :class="[textStylePrimary, hoverTextStylePrimary]">Smart Contracts</a></li>
                        <li><a id="Node Monitoring-link" class="font-medium text-sm mx-4 lg:mx-5 transition duration-150 ease-in-out" href="Node Monitoring.html" :class="[textStylePrimary, hoverTextStylePrimary]">Node Monitoring</a></li>
                        <li><a id="New Analysis Tool-link" class="font-medium text-sm mx-4 lg:mx-5 transition duration-150 ease-in-out" href="New Analysis Tool.html" :class="[textStylePrimary, hoverTextStylePrimary]">New Analysis Tool</a></li>
                    </ul>
                ...
                <button id="hello-world-button" class="btn-sm transition duration-150 ease-in-out ml-4 bg-purple-500 text-white rounded-full px-4 py-2 hover:bg-purple-600">
                    Hello World
                </button>
                ...
                <div id="mobile-menu" class="md:hidden flex items-center ml-4" x-data="{ expanded: false }">
                    ...
                    <nav id="mobile-nav" class="absolute top-full z-20 left-0 w-full px-4 sm:px-6 overflow-hidden transition-all duration-300 ease-in-out" x-ref="mobileNav" :style="expanded ? 'max-height: ' + $refs.mobileNav.scrollHeight + 'px; opacity: 1' : 'max-height: 0; opacity: .8'" @click.outside="expanded = false" @keydown.escape.window="expanded = false" x-cloak>
                        <ul id="mobile-nav-list" class="border border-transparent rounded-lg px-4 py-1.5" :class="signUpButtonGradient">
                            ...
                            <li><a id="mobile-Data Analysis-link" class="flex font-medium text-sm py-1.5" href="Data Analysis.html" :class="[textStylePrimary,hoverTextStylePrimary]">Data Analysis</a></li>
                            <li><a id="mobile-Smart Contracts-link" class="flex font-medium text-sm py-1.5" href="Smart Contracts.html" :class="[textStylePrimary,hoverTextStylePrimary]">Smart Contracts</a></li>
                            <li><a id="mobile-Node Monitoring-link" class="flex font-medium text-sm py-1.5" href="Node Monitoring.html" :class="[textStylePrimary,hoverTextStylePrimary]">Node Monitoring</a></li>
                            <li><a id="mobile-New Analysis Tool-link" class="flex font-medium text-sm py-1.5" href="New Analysis Tool.html" :class="[textStylePrimary,hoverTextStylePrimary]">New Analysis Tool</a></li>
                        </ul>
                    </nav>
