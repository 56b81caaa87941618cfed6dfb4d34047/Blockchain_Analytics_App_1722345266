        ...
        <div id="section-container" class="max-w-6xl mx-auto px-4 sm:px-6 bg-white flex">
            ...
            <div id="content-container" class="relative px-8 py-12 md:py-20 rounded-3xl overflow-hidden flex-1">
                ...
                <div id="content" class="max-w-3xl mx-auto text-center">
                    <div id="content-subtitle" class="flex"><div id="content-subtitle-text" class="flex-1 font-medium bg-clip-text pb-3" :class="[transparentTextStyle, contentSubtitleStyle]">Harness the Power of Blockchain Analytics</div></div>
                    ...
                    <div class="flex" id="content-body-container"><p id="content-body" class="flex-1 text-lg mb-8" :class="[contentBodyStyle]">Gain powerful analytics on emerging blockchain data with our cutting-edge analysis platform. Identify trends, opportunities, and risks before others.</p></div>
